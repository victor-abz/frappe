import { url, frappe as f } from './common';
import { Selector } from 'testcafe';

fixture(`Setup Wizard`)
	.page(url + '/login');

test('Can complete setup wizard', async t => {
	const wizard_heading = Selector(() => $('p.lead:visible')[0]); // lazy selector
	...
	await t
		...
		.setFilesToUpload(upload_input, '../../public/images/ui/bot.png')
		.click(upload_btn)
